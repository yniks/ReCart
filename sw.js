     ...
     function request(event)
    {
       ...
       var handle= async function(){
            ...
            console.log(event.request.url.search('%%%'))
            if(event.request.url.search('%%%')==-1)return fetch(event.request)
